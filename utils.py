...
def get_args():
    ...
    parser.add_argument('--dataset', type=str, default='pinwheel', help='which dataset to work with') #earthquake #'covid19' #'citibike'
    ...
    parser.add_argument('--gpu-num', type=int, default=2, help='GPU number')
